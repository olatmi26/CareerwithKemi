...
class JobListSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $spec6s=[
            ...
            'Information Technology Technical Officer',
            ...
            'AWS App service Developers',
            'Laravel Web App Developers',
        ...
        foreach ($spec1s as $key => $myspecmajor) {
            JobList::create([
                'career_id' =>1,
                'jobTitle'=> $myspecmajor
            ]);
        }
        foreach ($spec2s as $key => $myspecmajor) {
            JobList::create([
                'career_id' =>2,
                'jobTitle'=> $myspecmajor
            ]);
        }
        foreach ($spec3s as $key => $myspecmajor) {
            JobList::create([
                'career_id' =>3,
                'jobTitle'=> $myspecmajor
            ]);
        }
        foreach ($spec4s as $key => $myspecmajor) {
            JobList::create([
                'career_id' =>4,
                'jobTitle'=> $myspecmajor
            ]);
        }
        foreach ($spec5s as $key => $myspecmajor) {
            JobList::create([
                'career_id' =>5,
                'jobTitle'=> $myspecmajor
            ]);
        }
        foreach ($spec6s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 6,
                'jobTitle' => $myspecmajor
            ]);
        }
        foreach ($spec7s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 7,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec8s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 8,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec9s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 9,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec10s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 10,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec11s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 11,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec12s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 12,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec13s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 13,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec14s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 14,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec15s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 15,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec16s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 16,
                'jobTitle' => $myspecmajor
            ]);
        ...
        $spec17s=[
            ...
            'First-Line Supervisors o Tactical Operations Specialists',
        ...
        foreach ($spec17s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 17,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec18s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 18,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec19s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 19,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec20s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 20,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec21s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 21,
                'jobTitle' => $myspecmajor
            ]);
        ...
        foreach ($spec22s as $key => $myspecmajor) {
            JobList::create([
                'career_id' => 21,
                'jobTitle' => $myspecmajor
            ]);
